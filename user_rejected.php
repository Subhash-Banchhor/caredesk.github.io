...
<head>
    ...
    <title>User Rejected Complaints</title>
...
<div class="navbar" id="navbar">
    ...
    <div class="main3">
        ...
        <a href="user_rejected.php" id="active">Rejected Complaints</a><br>
...
$q="select * from complaint where reply='rejected' and UserName = '$name'";
